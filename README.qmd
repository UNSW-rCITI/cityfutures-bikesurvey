...
- Quarto 1.2 or newer.
- [Docker](https://www.docker.com/products/docker-desktop/) or MongoDB 4.4.0 (tested).

# Data extraction

Fourstep uses NOSQL database to store its data and user data uploaded from their mobile phone devices.
...
The following R code can be used to extract the data from the database and save it to CSV files.
...
The table appears to contain information about a user and their device, including app usage and device information.
